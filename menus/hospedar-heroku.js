...
atualizar como assim Sukuna? : exemplo> se você quer ativar alguma função do grupo, você deve desligar o botão no heroku, depois ir no termux, ligar o bot lá, esperar atualizar as credenciais, demora um pouco, caso demore muito, apague o "baileys_store_multi.json", e ligue novamente, pra desligar e ligar, apenas segure o volume de menos do celular e aperta a letra C do teclado. 

Caso continue bugando apague o qrcode "auth_info_multi.json", que se localizara dentro da pasta do bot que se chama SUKUNA BOT que está  dentro do armazenamento do seu celular, se quiser apagar por comando só digitar isso no termux e dá enter:  rm auth_info_multi.json  e   rm baileys_store.json  ,bom agora o resto é com vocês, vamos pra próxima parte.).then(res => {
